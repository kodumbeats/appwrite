...
docker buildx build --platform linux/amd64,linux/arm64,linux/arm/v6,linux/arm/v7,linux/ppc64le,linux/s390x -t kodumbeats/appwrite:$TRAVIS_BRANCH -t kodumbeats/appwrite:latest ./ --push